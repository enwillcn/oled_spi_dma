...
#define OLED_SCL_Clr() GPIOA->BSRR = (uint32_t)(GPIO_PIN_5 << 16)               //SPI1
#define OLED_SCL_Set() GPIOA->BSRR = (uint32_t)GPIO_PIN_5


// #define OLED_SDA_Clr() GPIOA->BSRR = (uint32_t)(GPIO_PIN_10 << 16)
// #define OLED_SDA_Set() GPIOA->BSRR = (uint32_t)GPIO_PIN_10

#define OLED_SDA_Clr() GPIOA->BSRR = (uint32_t)(GPIO_PIN_7 << 16)             //SPI1    
#define OLED_SDA_Set() GPIOA->BSRR = (uint32_t)GPIO_PIN_7

#define OLED_RES_Clr() GPIOA->BSRR = (uint32_t)(GPIO_PIN_9 << 16)
#define OLED_RES_Set() GPIOA->BSRR = (uint32_t)GPIO_PIN_9

#define OLED_DC_Clr()  GPIOA->BSRR = (uint32_t)(GPIO_PIN_8 << 16)
#define OLED_DC_Set()  GPIOA->BSRR = (uint32_t)GPIO_PIN_8
 		     
#define OLED_CS_Clr()  GPIOA->BSRR = (uint32_t)(GPIO_PIN_12 << 16)
#define OLED_CS_Set()  GPIOA->BSRR = (uint32_t)GPIO_PIN_12
